...
describe("state > study > log > reducer", () => {
  ...
  it("should handle QUIZ_LOG_RECIEVE_QUESTION_SUCCESSFULLY_ANSWERED_DATE", () => {
  ...
  it("should handle QUIZ_LOG_RECIEVE_QUESTION_SUCCESSFULLY_ANSWERED_DATE - already answered", () => {
    const date2 = new Date();
  ...
  it("should handle QUIZ_LOG_CLEAR_QUESTION_SUCCESSFULLY_ANSWERED_DATES", () => {
    const actualState = reducer(defaultState, {

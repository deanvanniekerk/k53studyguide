...
describe("state > test > log > reducer", () => {
  ...
  it("should handle TEST_LOG_RECIEVE_QUESTION_SUCCESSFULLY_ANSWERED_DATE", () => {
  ...
  it("should handle TEST_LOG_RECIEVE_QUESTION_SUCCESSFULLY_ANSWERED_DATE - already answered", () => {
    const date2 = new Date();
  ...
  it("should handle TEST_LOG_INCREMENT_PASSED_TESTS", () => {
    const state = {
      ...defaultState,
      testsPassed: 5,
    };
  ...
  it("should handle TEST_LOG_CLEAR_PASSED_TESTS", () => {
    const state = {
      ...defaultState,
      testsPassed: 5,
    };
  ...
  it("should handle TEST_LOG_CLEAR_QUESTION_SUCCESSFULLY_ANSWERED_DATES", () => {
    const state = {
      ...defaultState,
    };

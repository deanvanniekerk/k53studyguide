...
import type { ContentData, ContentItem, NavigationData } from "@/data";
...
export const currentNavigationKeySelector: OutputSelector<RootState, string, (state: NavigationState) => string> =
...
export const currentNavigationParentSelector: OutputSelector<RootState, string, (key: string) => string> =
